...
import com.raniere.cursomc.domain.Pagamento;
import com.raniere.cursomc.domain.PagamentoComBoleto;
import com.raniere.cursomc.domain.PagamentoComCartao;
...
import com.raniere.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, 
		           "Ana Costa", 
		           "me.raniere@gmail.com", 
		           "31628382740", 
		           TipoCliente.PESSOAFISICA,
		           pw.encode("123"));
		
		cli2.getTelefones().addAll(Arrays.asList("65498467", "516871654"));
		cli2.addPerfil(Perfil.ADMIN);		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "78777012", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2018 19:25"), cli1, e2);
